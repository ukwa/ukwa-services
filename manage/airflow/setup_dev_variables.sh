...
./run-airflow-cmd.sh airflow connections add --conn-uri "http://trackdb.dapi.wa.bl.uk/solr/tracking" --conn-description "The TrackDB Solr instance to update and use to drive indexing etc." trackdb_url
